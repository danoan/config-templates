...
require('packer').startup(function(use)
        ...
        config = function ()
            require'nvim-treesitter.configs'.setup({
              ...
              highlight = {
                ...
                disable = { markdown, lua },  -- list of language that will be disabled
    ...
    -- This is not working anymore after updates (2022-11-10) Try again
    -- when nvim 0.9 is tagged as release
    -- use {
